...
def about(root):
    ...
    \naidan.quachh@gmail.com (Aidan Quach)\nfireplaypus375@gmail.com (Haris Rajesh)\nGithub: https://github.com/xIntensity9/FBLA-22-23"""
    ...
    aboutText = ctk.CTkLabel(root1,text=text, font=("Quicksand",15), text_color="white", wraplength=550)
    aboutText.place(relx=0.50, rely=0.55, anchor="center")
