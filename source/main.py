...
font = Font(file="Quicksand-Bold.ttf", family="Quicksand")
...
def leaderboard_open(grade=9):
    leaderboard(grade)
leaderboard_image = Image.open("leaderboard.png")
...
event_image = Image.open("event.png")
...
add_student_image = Image.open("add_student.png")
...
view_image = Image.open("view_entries.png")
...
create_report_image = Image.open("create_report.png")
...
view_requests_image = Image.open("view_requests.png")
...
prize_image = Image.open("prizes.png")
...
upcoming_event_image = Image.open("upcoming_events.png")
...
sign_in_image = Image.open("sign_in.png")
...
forward_image = Image.open("right_arrow.png")
...
backward_image = Image.open("left_arrow.png")
...
register_image = Image.open("register.png")
...
sign_out_image = Image.open("sign_out.png")
